...
commander
    ...
    .option('-f, --classesFile <classesFile>', 'Name or relative path of the file with the custom types')
    .option('-t, --typeName <typeName>', 'Name of the type exported from file containing the custom classes')
    .action(function (_a) {
